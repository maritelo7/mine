...
public class Venta implements Serializable {
  ...
  public void setTotalVenta(){
    ...
    for (int i = 0; i < listaProductos.size(); i++) {
      ...
      total = total + prodVenta.getSubtotal();
    }
  ...
  public String toStringVoid () {
    return "\n\nComprobante de venta num.: " + folio + " Fecha de compra: " + fecha 
      + " Total de la compra: " + totalVenta + " \nLista de productos: ";
  }
  
  public int tamanioListaProd(){
  return listaProductos.size();
  }
  
  
  public String listaProd(int c){
      ProductoVenta prodVenta = new ProductoVenta();
      prodVenta = listaProductos.get(c);      
      return " \nArtículo: " + prodVenta.getNombre() + "  Cantidad: " + prodVenta.getCantidad()
