...
public class ControlInventarioFXController implements Initializable {
  ...
  private void desplegarProdNombre(ActionEvent event) {
    ...
    infoArea.setText(in.buscarNombreGUI(nombre));
    }    
  }

  @FXML
  private void desplegarProdClave(ActionEvent event) {
    if(!claveTF.getText().isEmpty()){   
    int clave = Integer.valueOf(claveTF.getText());
    infoArea.setText(in.buscarClaveS(clave));
    }  
  }

  @FXML
  private void desplegarProdDescripcion(ActionEvent event) {
    if(!descripcionTF.getText().isEmpty()){   
    String descripcion = descripcionTF.getText();
    infoArea.setText(in.buscarDescripcionGUI(descripcion));
    }    
  }
